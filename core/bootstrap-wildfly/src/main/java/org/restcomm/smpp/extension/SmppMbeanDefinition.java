...
public class SmppMbeanDefinition extends SimpleResourceDefinition {
    ...
    private SmppMbeanDefinition() {
        super(MBEAN_PATH,
                SmppExtension.getResourceDescriptionResolver(MBEAN),
                SmppMbeanAdd.INSTANCE,
                SmppMbeanRemove.INSTANCE);
    }

    @Override
    public void registerChildren(ManagementResourceRegistration resourceRegistration) {
        super.registerChildren(resourceRegistration);
        resourceRegistration.registerSubModel(SmppMbeanPropertyDefinition.INSTANCE);
    }
